...
const EmailStepper = ({user}) =>{
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            .required('This is required')
            .email('This is not a valid email')
            .test('equal','The emails are same',(newemail)=>{
    ...
    const nextBtn = () =>(
        <Button className="mt-3 ml-3" variant="contained" color="primary"
         onClick={handleNext}
        >
            Next
        </Button>
    ...
    const backBtn = () =>(
        <Button className="mt-3 mr-3" variant="contained"
         onClick={handleBack}
        >
            Back
        </Button>
    ...
    return(
       <>
         ...
         {activeStep === 2 ?
            <div className="form-group">
              {backBtn()}
              <Button className="mt-3 mr-3" variant="contained" color="primary" onClick={formik.submitForm}>Of course yes!</Button>
           </div>
